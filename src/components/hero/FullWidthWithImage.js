...
import img1 from "../../images/classic/img1.jpg";
...
export default ({
  navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="#">Inscription</NavLink>
    </NavLinks>
  ],
  heading = (
    <>
      Unis pour la Solidarité : 
      <wbr />
      <br />
      <span tw="text-primary-500">Créez ou Rejoigner <br/>des Maraudes</span>
    </>
  ),
